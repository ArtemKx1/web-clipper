...
export default function EmptyState({ isSearching, searchQuery }: EmptyStateProps) {
  ...
  if (searchQuery) {
    return (
      <div className="flex flex-col items-center justify-center h-full text-center px-6 py-16">
        ...
        <p className="font-semibold mb-1 text-foreground">No results found</p>
  ...
  return (
    <div className="flex flex-col items-center justify-center h-full text-center px-6 py-12">
      ...
      {/* Text */}
      <h3 className="text-2xl font-bold mb-2 text-foreground tracking-tight">Your second brain awaits</h3>
      <p className="text-sm mb-8 max-w-[260px] text-muted-foreground">Capture anything from the web. Lightning fast.</p>
      
      {/* Quick capture guide */}
      <div className="rounded-2xl p-5 text-left w-full max-w-[300px] bg-surface-2 border border-border shadow-md">
        <p className="text-[10px] font-bold uppercase tracking-widest mb-4 text-muted-foreground">Quick capture</p>
        <div className="space-y-3">
          <div className="flex items-center gap-3">
            ...
            <span className="text-xs text-muted-foreground">Capture selection or page</span>
          </div>
          <div className="flex items-center gap-3">
            <kbd className="px-2.5 py-1.5 rounded-lg text-[10px] font-bold bg-surface-3 text-muted-foreground border border-border/50">
              Right-click
            </kbd>
            <span className="text-xs text-muted-foreground">Save text, image, or link</span>
          </div>
        </div>
      </div>
    </div>
